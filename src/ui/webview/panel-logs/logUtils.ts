...
import type { UiLogEntry } from '../../protocol/generated-types';
import type { SearchOptions } from '../common/utils/searchUtils';
import { createSearchMatcher, highlightMatches } from '../common/utils/searchUtils';
import { formatSource } from '../common/utils';

// Re-export shared utilities for convenience
export { ansiConverter, hashStringToColor, formatTimestamp } from '../common/utils';
import { ansiConverter, hashStringToColor, formatTimestamp } from '../common/utils';
...
export function tryParseStructuredTraceback(
  pythonTraceback: string | null | undefined
): StructuredTraceback | null {
