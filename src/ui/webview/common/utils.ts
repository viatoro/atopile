...
import type { Build, BuildStage, BuildStatus, StageStatus } from "../../protocol/generated-types";
import { SOURCE_COLORS, type TimeMode } from "../../protocol/types";
import { createWebviewLogger } from './logger';
import { WebviewRpcClient, rpcClient } from './webviewRpcClient';

export const STATUS_ICONS: Partial<Record<BuildStatus | StageStatus, LucideIcon>> = {
