...
class Uniform {
    ...
    i1(x: number) { this.gl.uniform1i(this.location, x); }
...
export class Buffer {
    ...
    /** Bind this buffer to a vertex attrib location (for use outside the owning VAO) */
    bind_attrib(attrib: number, size: number = 1) {
        this.bind();
