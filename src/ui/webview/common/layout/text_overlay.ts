...
const DEFAULT_PAD_ANNOTATION_TEXT_DARK = "rgba(13, 20, 31, 0.98)";
const DEFAULT_PAD_ANNOTATION_TEXT_LIGHT = "rgba(248, 250, 252, 0.98)";
const DEFAULT_PAD_ANNOTATION_OUTLINE = "rgba(255, 255, 255, 0.72)";
const LIGHT_PAD_ANNOTATION_OUTLINE = "rgba(15, 23, 42, 0.72)";
...
export function renderTextOverlay(
    ...
    const padAnnotationTextDark = DEFAULT_PAD_ANNOTATION_TEXT_DARK;
    const padAnnotationTextLight = DEFAULT_PAD_ANNOTATION_TEXT_LIGHT;
    const padAnnotationOutline = isLightTheme
        ? LIGHT_PAD_ANNOTATION_OUTLINE
        : DEFAULT_PAD_ANNOTATION_OUTLINE;
    ...
    for (const idx of fpIndices) {
        ...
        for (const layerName of layerNames) {
            ...
            const badgeTextColor = relativeLuminance(r, g, b) >= 0.52
                ? padAnnotationTextDark
                : padAnnotationTextLight;
            ...
            for (const number of geometry.numbers) {
                ...
                ctx.strokeStyle = padAnnotationOutline;
                ctx.stroke();
