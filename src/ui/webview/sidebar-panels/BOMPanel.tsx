...
import { formatCurrency, formatStock, getTypeLabel } from "../common/utils/format";
import type { UiBOMComponent, UiLcscPartData } from "../../protocol/generated-types";
import { samePath, resolveUsageFilePath } from "../../protocol/paths";
import "./BOMPanel.css";
...
export function BOMPanel() {
  const { projectState, bomData, refreshBom } = useBomRefresh();
  ...
  // Reset local UI state when project/target changes (refreshBom identity changes)
  useEffect(() => {
