...
type AgentMessageForFileSummary = {
  id: string;
  role: string;
  toolTraces?: Pick<AgentTraceView, 'name' | 'ok' | 'result'>[] | null;
};
...
export function collectChangedFilesSummary(messages: AgentMessageForFileSummary[]): AgentChangedFilesSummary | null {
