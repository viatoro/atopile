...
class UiStore(CamelModel):
    ...
    selected_build_in_progress: bool = False
    ...
    stackup_data: UiStackupData = Field(
        default_factory=UiStackupData, json_schema_extra={"mergeable": True}
    )
    pinout_data: UiPinoutData = Field(
        default_factory=UiPinoutData, json_schema_extra={"mergeable": True}
    )
    ...
    recent_builds_data: UiRecentBuildsData = Field(default_factory=UiRecentBuildsData)
    ...
    autolayout_data: UiAutolayoutData = Field(
        default_factory=UiAutolayoutData, json_schema_extra={"mergeable": True}
    )
