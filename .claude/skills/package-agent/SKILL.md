...
Import the package directly from its path, e.g. `from "packages/<name>/<file>.ato" import Thing`. Do **not** add file dependencies to `ato.yaml` — file dependencies are for referencing files outside the source directory.
